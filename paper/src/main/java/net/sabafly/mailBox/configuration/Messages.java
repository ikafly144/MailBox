...
/**
 * All user-facing messages for MailBox.
 * Defaults are loaded from the built-in locale files (en.yml, zh_CN.yml, ja_JP.yml).
 * Users can customize messages by editing the locale file for their preferred language.
 */
@ConfigSerializable
